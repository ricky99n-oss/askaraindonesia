    ...
    <section id="pricing" className="py-24 px-6 bg-gray-50 border-t border-gray-100">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 bg-orange-50 border border-orange-200 rounded-2xl p-6 text-center max-w-2xl mx-auto">
          <p className="text-askara-orange font-black text-xl uppercase tracking-wide mb-2">GRATIS 2 BULAN !</p>
          ...
          >
            {isBetaFull ? 'TUTUP: Kuota Beta Sudah Habis' : 'Jadilah Beta Tester FREE 2 Bulan'}
          </button>
        </div>
      </div>
    </section>
