            ...
            <div className="p-6 overflow-y-auto">
              <form onSubmit={handleKlaimSubmit} className="space-y-4">
                ...
                <div className="pt-2 space-y-3">
                  <label className="flex items-start gap-3 cursor-pointer group"><div className="shrink-0 mt-0.5"><input type="checkbox" name="cekFeedback" required checked={formData.cekFeedback} onChange={handleInputChange} className="w-4 h-4 text-purple-600 rounded border-gray-300 focus:ring-purple-500" /></div><span className="text-sm text-gray-600">Saya bersedia aktif mengirimkan Feedback selama 3 bulan pertama.</span></label>
