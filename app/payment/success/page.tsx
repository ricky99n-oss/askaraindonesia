...
// Komponen terpisah untuk menangkap parameter URL
...
// Halaman utama yang dibungkus Suspense
export default function PaymentSuccessPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <Suspense fallback={<div className="text-gray-500 font-bold animate-pulse">Memuat data transaksi...</div>}>
